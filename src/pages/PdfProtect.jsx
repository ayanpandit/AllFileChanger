...
export default function PdfProtect() {
  ...
  const handleProtect = async () => {
    ...
    try {
      ...
      const res = await fetchWithWakeUp(`${import.meta.env.VITE_PYTHON_API_URL}/api/pdf/protect`, { method: 'POST', body: formData });
      if (res.ok) {
