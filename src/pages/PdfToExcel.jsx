...
import { pdfToExcelData } from '../data/pageContentData';
...
function PdfToExcel() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      const response = await fetchWithWakeUp(`${import.meta.env.VITE_PYTHON_API_URL}/api/pdf/to-excel`, { method: 'POST', body: formData });
      if (response.ok) {
