...
function ImageBackgroundRemove() {
  ...
  const handleRemoveBackground = async () => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_IMAGEBACKGROUNDREMOVE_URL}/remove-background`, {
        method: 'POST',
        body: formData,
      });
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black transition-all duration-500">
      <Helmet>
        <title>Free Background Remover Online | Remove Image Background - AllFileChanger</title>
        <meta name="description" content="Remove image backgrounds online for free. AI-powered background remover for photos. Support JPG, PNG, WebP. Fast, accurate, and easy to use." />
        <link rel="canonical" href="https://allfilechanger.com/image-background-remove" />
      </Helmet>
      
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-indigo-600 via-blue-600 to-purple-800 dark:from-black dark:via-black dark:to-black">
        <div className="absolute inset-0 bg-black/20 dark:bg-black/80 transition-all duration-500"></div>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
          <div className="text-center">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-indigo-500 to-blue-600 rounded-3xl mb-6 shadow-2xl transition-all duration-300 hover:scale-110">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 sm:mb-6 transition-all duration-500 leading-tight">
              <span className="text-yellow-300 dark:text-yellow-400">Background Remover</span> Tool
            </h1>
            <p className="text-lg sm:text-xl lg:text-2xl text-indigo-100 dark:text-gray-200 max-w-4xl mx-auto mb-6 sm:mb-8 transition-all duration-500 px-4">
              Remove backgrounds from images with <strong className="text-white">AI precision</strong>. 
              Free, fast, and works directly in your browser!
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center px-4">
              <div className="text-indigo-100 dark:text-gray-300 text-sm sm:text-base transition-colors duration-500 text-center">
                ✓ 100% Free  ✓ AI-Powered  ✓ High Quality  ✓ Instant Processing
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="p-4 sm:p-6 lg:p-8">
              <div
                className={`relative border-2 border-dashed rounded-xl p-6 sm:p-8 lg:p-12 text-center transition-all duration-300 ${
                  dragActive
                    ...
                    : 'border-gray-300 dark:border-gray-800 hover:border-indigo-400 dark:hover:border-indigo-500'
                }`}
                onDrop={handleDrop}
              ...
              >
                <div className="space-y-4 sm:space-y-6">
                  <div className="mx-auto w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-r from-indigo-500 to-blue-600 rounded-2xl flex items-center justify-center shadow-lg">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300 transition-colors duration-500">
                      or <span className="text-indigo-600 dark:text-indigo-400 font-medium">click to select a file</span> from your device
                    </p>
                  </div>
            ...
            {selectedFile && (
              <div className="border-t border-gray-200 dark:border-gray-800 p-6 sm:p-8">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-green-800 dark:text-green-200 font-medium">
                          Background removed successfully! Download started automatically.
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 text-white font-semibold py-4 px-8 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
                >
                  {isProcessing ? (
                    <>
