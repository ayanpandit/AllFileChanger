...
import { pptConverterData } from '../data/pageContentData';
...
export default function PPTtoPDF() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      const response = await fetchWithWakeUp(`${API_URL}/ppt-convert`, { method: 'POST', body: formData });
